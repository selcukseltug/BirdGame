package com.selcukseltug.birdgame;
...
public class BirdGame extends ApplicationAdapter {
    ...
    public void create() {
        ...
        ship1 = new Texture("ship1.png");
        ship2 = new Texture("ship1.png");
        ship3 = new Texture("ship1.png");
        ...
        for (int i = 0; i < numberOfEnemies; i++) {
            ...
            enemyX[i] = Gdx.graphics.getWidth() - ship1.getWidth() / 2 + i * distance;
    ...
    public void render() {
        ...
        if (gameState == 1) {
            ...
            if (Gdx.input.justTouched()) {
                ...
                if (birdy < Gdx.graphics.getHeight()-bird.getHeight()/4) {
                    velocity = -6;
                }
            ...
            for (int i = 0; i < numberOfEnemies; i++) {
                ...
                batch.draw(ship1, enemyX[i], Gdx.graphics.getHeight() / 2 + enemyOffSet[i], Gdx.graphics.getWidth() / 15, Gdx.graphics.getHeight() / 10);
                batch.draw(ship2, enemyX[i], Gdx.graphics.getHeight() / 2 + enemyOffSet2[i], Gdx.graphics.getWidth() / 15, Gdx.graphics.getHeight() / 10);
                batch.draw(ship3, enemyX[i], Gdx.graphics.getHeight() / 2 + enemyOffSet3[i], Gdx.graphics.getWidth() / 15, Gdx.graphics.getHeight() / 10);
